...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        request_renderer thread = new request_renderer();
        thread.start();
    ...
    class request_renderer extends Thread {
        ...
        public void run() {
            while (true) {
                ...
                if (Pause_flag == false) {
                    for (int x = 0; x < 32; x++) {
                        for (int y = 0; y < 1024; y++) {
                            mGL.mBitmap.setPixel( x, 1023-y, Color.rgb( (int) time+(x*255/32), (int) time+(x*255/32), (int) time+(x*255/32) ) );
                        }
                    }
                }
                ...
                try {
                    ...
                    Log.d("Thread error", "Thread Read Exception : " + e);
                }
            }
        }
    }
